      ...
      <Animated.View style={{
        ...
        <View style={{
          ...
          <View style={{
            ...
            <Image source={require('../assets/images/metamask.png')} style={{
              position: 'absolute',
              left: scaleWidth(10),
              zIndex: 1,
          ...
          <View style={{
            ...
            <Image source={require('../assets/images/TrustWallet.png')} style={{
              position: 'absolute',
              left: scaleWidth(10),
              zIndex: 1,
              width: isTablet ? scaleWidth(30) : scaleWidth(24),
          ...
          <View style={{
            ...
            <Image source={require('../assets/images/CoinBase.png')} style={{
              position: 'absolute',
              left: scaleWidth(10),
              zIndex: 1,
              width: isTablet ? scaleWidth(30) : scaleWidth(24),
          ...
          <View style={{
            ...
            <Image source={require('../assets/images/Binance.png')} style={{
              position: 'absolute',
              left: scaleWidth(10),
              zIndex: 1,
              width: isTablet ? scaleWidth(30) : scaleWidth(24),
